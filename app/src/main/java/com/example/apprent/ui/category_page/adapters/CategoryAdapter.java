...
// Загрузка изображения с помощью Glide и применение преобразований
        ...
        holder.categoryName.setText(((CategoryItem) itemArrayList.get(position)).getName());
        holder.itemView.setOnClickListener(v -> goNext((CategoryItem) itemArrayList.get(position)));
    }
